...
public class DecoderActivity extends AppCompatActivity
    ...
    protected void onResume() {
        ...
        if (qrCodeReaderView != null) {
            ...
            if (autoScannerView != null) {
                autoScannerView.setCameraManager(qrCodeReaderView.getCameraManager());
            }
        }
    }
    ...
    protected void onPause() {
        ...
        if (qrCodeReaderView != null) {
            ...
            if (autoScannerView != null) {
                autoScannerView.setCameraManager(null);
            }
        }
    }
    ...
    private void initQRCodeReaderView() {
        ...
        autoScannerView = (AutoScannerView) content.findViewById(R.id.autoscanner_view);
    }
}